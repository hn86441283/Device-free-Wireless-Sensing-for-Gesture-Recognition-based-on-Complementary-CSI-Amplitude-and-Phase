...
clear;
close all;
load data_after_fisher.mat;
[m,n] = size(after_fisher_data);
[coeff, score, latent, tsquared, explained, mu]=pca(after_fisher_data(:,1:n-1));
...
Feature = [Feature,after_fisher_data(:,end)];